...
export const components = {
  ...
  "tokenSelectionModal.selectChain": "Select a chain",
  ...
  "graduationExplanationModal.whatIsGraduationDescription":
    "Graduation requires paying a fee in USDC to unlock revenue-generating features for your DEX. Once graduated, your DEX becomes eligible to earn trading fees from users.",
  ...
  "graduationExplanationModal.step1": "Pay the graduation fee in USDC",
