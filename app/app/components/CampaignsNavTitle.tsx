  ...
  return (
    <>
      <span
        ...
        aria-hidden="true"
      >
        <CampaignsFlameIcon className="size-5" gradientId={gradientId} />
      </span>
      <span className="text-base-contrast">{title}</span>
...
function CampaignsFlameIcon(
  props: SVGProps<SVGSVGElement> & { gradientId: string }
) {
